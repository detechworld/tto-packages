...
describe("deip.auth: Crypto", function() {
...
describe("deip.auth: derives", () => {
    ...
    let to_public = PublicKey.fromStringOrThrow("DT7vbxtK1WaZqXsiCHPcjVFBewVj8HFRd5Z5XZDpN6Pvb2dZcMqK")
    ...
    it("child from public", () => assert.equal(
        ...
        "DT6XA72XARQCain961PCJnXiKYdEMrndNGago2PV5bcUiVyzJ6iL",
